      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input v-model="listQuery.id" class="input-width" placeholder="订单编号"></el-input>
          </el-form-item>
  ...
  export default {
    ...
    methods:{
      ...
      handleViewDetail(index,row){
        this.$router.push({path:'/oms/returnApplyDetail',query:{_id:row._id}})
      },
      ...
      getList(){
        this.$axios.get('/apply/all',{params:this.listQuery}).then(res=>{
          if (res.status === 200){
